...
public class Task
{
	...
	//public ArrayList<String> predecess;
	...
	/*public Task(String id, int duration, ArrayList<String> predecess)// Edge Incoming1, Edge Incoming)
	{
		this.duration = duration;
		this.tIdentifier = id;
//		for (Task t : predecess)
//		{
...
//		}
	...
	public void IsinCriticalPath( )
	{
     ...
     public boolean isDependent(Task t) {
         ...
         if (predecess.contains(t)) {
             return true;
         }
         // is t an indirect dependency
         for (Task dep : predecess) {
	 ...
	 //public void setLatest() {
       //  LateStart = maxCost - criticalCost;
	...
	/*public class CriticalPath {
	    ...
	    public static class Task {
	        ...
	        public int cost;
	        // the accumulated cost of the tasks along the critical path
